...
export default function InitialLoader() {
  ...
  return (
    <div className="flex h-screen w-full flex-col items-center bg-background pt-48">
        <div className="text-center">
            <h1 className="text-8xl font-bold tracking-tighter text-foreground animate-text-glow" style={{ fontFamily: 'serif' }}>
                NLS
            </h1>
            <p className="mt-2 text-lg font-light tracking-[0.4em] text-foreground/80 animate-pulse-subtle">
                ENTERTAINMENT
            </p>
