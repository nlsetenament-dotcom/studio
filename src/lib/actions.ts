...
const createCompanionSchema = z.object({
  ...
  birthDay: z.string().refine(val => !isNaN(parseInt(val, 10)) && parseInt(val, 10) > 0 && parseInt(val, 10) <= 31, { message: "Día debe ser un número entre 1 y 31." }),
  birthMonth: z.string().refine(val => !isNaN(parseInt(val, 10)) && parseInt(val, 10) > 0 && parseInt(val, 10) <= 12, { message: "Mes debe ser un número entre 1 y 12." }),
  birthYear: z.string().refine(val => !isNaN(parseInt(val, 10)), { message: "Año debe ser un número." }),
