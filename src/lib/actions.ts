...
const createCompanionSchema = z.object({
  ...
  birthDay: z.string().refine(val => !isNaN(parseInt(val, 10)), { message: "Día debe ser un número." }),
  birthMonth: z.string().refine(val => !isNaN(parseInt(val, 10)), { message: "Mes debe ser un número." }),
